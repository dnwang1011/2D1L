    ...
    <div className="min-h-screen flex items-center justify-center bg-backgroundDark p-4">
      <div className="bg-backgroundLight p-8 rounded-lg shadow-xl w-full max-w-md">
        ...
        <form className="space-y-6">
          ...
          <div>
            <label htmlFor="confirm-password" className="block text-sm font-medium text-textDark">
              Confirm Password
            </label>
            <input
              id="confirm-password"
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          Already a member? <a href="/login" className="font-medium text-accent hover:text-opacity-80">Sign in</a>
        </p>
      </div>
    </div>
  );
