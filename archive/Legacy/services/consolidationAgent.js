...
const aiConfig = require('../../Legacy/config/ai.config'); // Import aiConfig
const episodicConfig = require('../../Legacy/config/episodic.config'); // Import episodic config
const queueConfig = require('../../Legacy/config/queue.config'); // Import queue config
