...
module.exports = {
  ...
  defaultRetrievalLimit: 10, // Increased to provide more context
  ...
  defaultRetrievalMinImportance: 0.4, // Lowered to include more memories in context
  ...
  defaultRetrievalCertainty: 0.35, // Lowered to allow more memories to be retrieved
