...
module.exports = {
  ...
  similarityThreshold: parseFloat(process.env.EPISODE_SIMILARITY_THRESHOLD) || 0.60, // Primary threshold to attach chunk to an episode
  multipleAttachmentSimilarityThreshold: parseFloat(process.env.MULTIPLE_ATTACHMENT_SIMILARITY_THRESHOLD) || 0.55, // Threshold for attaching to additional episodes
  newEpisodeSeedThreshold: parseFloat(process.env.NEW_EPISODE_SEED_THRESHOLD) || 0.55, // If max similarity is below this, consider seeding a new episode
  maxCandidateEpisodes: parseInt(process.env.MAX_CANDIDATE_EPISODES, 10) || 50, // Limit how many episodes we check similarity against
